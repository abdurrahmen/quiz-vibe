...
export default function AdminLogin() {
  ...
  return (
    <div className="bg-linear-to-br from-primary-container to-tertiary-container min-h-screen flex items-center justify-center p-6">
          ...
          <form action={formAction} className="space-y-6 relative z-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="email"
                  autoComplete="email"
                  defaultValue="admin.quizvibe@gmail.com"
                  placeholder="admin.quizvibe@gmail.com"
            ...
            <div className="flex flex-col gap-3 mt-2">
              <button
                type="submit"
                disabled={isPending}
                className="w-full bg-linear-to-r from-primary to-tertiary text-white font-bold py-3.5 px-6 rounded-2xl shadow-primary hover:shadow-primary-lg transition-all flex justify-center items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
              >
